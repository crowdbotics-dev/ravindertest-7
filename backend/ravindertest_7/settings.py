"""
Django settings for ravindertest_7 project.
...
ROOT_URLCONF = 'ravindertest_7.urls'
...
WSGI_APPLICATION = 'ravindertest_7.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ravindertest_7 API",
    "DESCRIPTION": "API documentation for ravindertest_7 App",
    "VERSION": "v1",
}
